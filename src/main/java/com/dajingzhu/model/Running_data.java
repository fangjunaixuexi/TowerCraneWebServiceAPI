...
public class Running_data {
	...
	public String toString() {
		return "Running_data [device_sn=" + device_sn + ", tower_cranemodel=" + tower_cranemodel
				+ ", tower_crance_name=" + tower_crance_name + ", monitoring_time=" + monitoring_time
				+ ", lifting_weight=" + lifting_weight + ", range=" + tower_range + ", moment_percentage=" + moment_percentage
				+ ", rotation=" + rotation + ", height=" + height + ", wind_speed=" + wind_speed + ", dipangle="
				+ dipangle + ", multiple_rate=" + multiple_rate + ", alarm_state=" + alarm_state + ", on_line="
				+ on_line + "]";
	}
